...
namespace quantizePst
{
    internal class Program
    {
        ...
        public static decimal[] QuantizeToDecimal(byte[][] inputArrays)
        {
            ...
            var quantizedArray = new decimal[numValues];

            for (var i = 0; i < numValues; i++)
            {
                BigInteger packedValue = 0;
                ...
                quantizedArray[i] = (decimal)packedValue;
            }
        ...
        public static int[][] UnpackToInt(decimal[] quantizedArray)
        {
            ...
            for (var j = 0; j < numArrays; j++)
            {
                ...
                for (var i = 0; i < numValues; i++)
                {
                    int value = (int)((int)(((BigInteger)quantizedArray[i] >> (j * 8)) & 255) * commpressAmount);
                    unpackedArrays[j][i] = value;
                }
            }
        ...
        public static void Main(string[] args)
        {
            ...
            for (var i = 0; i < quantizedArray.Length; i++)
            {
                ...
                Console.Write("{0} ", quantizedArray[i] + "m, ");
            }
